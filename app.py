...
if p_value > alpha:
    st.write(f"Можно говорить о том, что нет статистически значимой разницы между двумя выборками")
else:
    st.write(f"Можно говорить о том, что есть статистически значимая разница между двумя выборками")
...
age = st.number_input("Введите ваш возраст:", min_value=23, max_value=40, value=35)
